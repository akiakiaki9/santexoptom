...
import CHASHAGENS from '../utils/chashagen';
import './chashagen.css';
...
const Chashagen = () => {
    ...
    const types = [...new Set(CHASHAGENS.map(item => item.type))];
    const lengths = [...new Set(CHASHAGENS.map(item => item.length))].sort((a, b) => a - b);
    const widths = [...new Set(CHASHAGENS.map(item => item.width))].sort((a, b) => a - b);

    // Фильтрация товаров
    const filteredProducts = CHASHAGENS.filter(product => {
    ...
    return (
        <>
            <main className="chashagens-main">
                <div className="chashagens-container">
                    {/* Хлебные крошки */}
                    <div className="breadcrumbs">
                        <a href="/">Главная</a> / <span>Чашагены</span>
                    </div>

                    <div className="chashagens-header">
                        <h1 className="chashagens-title">Чашагены</h1>
                    ...
                    <div className="chashagens-content">
                            ...
                            <div className="modal-info">
                                ...
                                <table className="product-specs">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Размеры (Д×Ш):</td>
                                            <td>{selectedProduct.length} x {selectedProduct.width} мм</td>
                                        </tr>
                                        <tr>
                                            <td>Глазурь:</td>
